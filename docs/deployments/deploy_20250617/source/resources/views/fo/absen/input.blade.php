<form id="frmSubmit" style="margin:10px;" method="POST" action="{{ route($viewModel->data->action) }}" enctype="multipart/form-data">
    ...
    <div>
        ...
        <input type="hidden" id="utc_tz" name="utc_tz" placeholder="utc_tz">
        <input type="hidden" id="utc_millis" name="utc_millis" placeholder="utc_millis">
        <input type="hidden" id="utc_offset" name="utc_offset" placeholder="utc_offset">
